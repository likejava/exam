			...
			<div style="padding: 50px 100px 10px;">
				<form class="form-horizontal" action="subjectAdd.action" method="post" name="form1">
					<div class="form-group"> 
						...
						<div class="col-sm-2"> 
							<input class="form-control" type="text" name="subject.score" id="score" placeholder="请输入分值"> 
						</div> 
					</div>
					<div class="form-group"> 
						<label class="col-sm-2 control-label">题目</label> 
						<div class="col-sm-8"> 
							<input class="form-control" type="text" name="subject.subjectTitle" id="subjectTitle" placeholder="请输入题目"> 
						</div> 
					</div>
					...
					<div class="form-group"> 
						...
						<div class="col-sm-2"> 
							<input class="form-control" type="text" id="optionA" name="subject.subjectOptionA" placeholder="请输入选项A"> 
						</div> 
					</div>
					<div class="form-group"> 
						<label class="col-sm-2 control-label">选项B</label> 
						<div class="col-sm-2"> 
							<input class="form-control" id="optionB" name="subject.subjectOptionB" placeholder="请输入选项B"> 
						</div> 
					</div>
					<div class="form-group"> 
						<label class="col-sm-2 control-label">选项C</label> 
						<div class="col-sm-2"> 
							<input class="form-control" id="optionC" name="subject.subjectOptionC" placeholder="请输入选项C"> 
						</div> 
					</div>
					<div class="form-group"> 
						<label class="col-sm-2 control-label">选项D</label> 
						<div class="col-sm-2"> 
							<input class="form-control" id="optionD" name="subject.subjectOptionD" placeholder="请输入选项D"> 
						</div> 
					</div>
					<div class="form-group"> 
